...
public class Lenguaje {
    static public String P1,P2,P3,P4,P5,P6,P7,P8,P9,P10,P11,P12,P13,P14,P15,P16,P17,P18,P19,P20,P21,P22,P23,P24,P25,P26,P27,P28,P29,P30,P31,P32,P33,P34,P35,P36,P37,P38,P39,P40,P41,P42,P43,P44,P45,P46,P47,P48,P49,P50,P51,P52,P53,P54,P55,P56,P57,P58,P59,P60,P61,P62,P63,P64,P65,P66,P67,P68;
    ...
    public static void ru(){
        //menu principal
        P1 = "_______Главное меню______";
        P2 = "Добро пожаловать в игру ";
        P3 = "Начать               ";
        P4 = "Бесконечный          ";
        P5 = "Язык                ";
        P6 = "Кредиты             ";
        ...
        P8 = "Выход               ";
        //Creditos
        P9 = "________________Кредиты________________";
        P10 = "|               Создатель:               |";
        P11 = "|            Оригинальная идея:            |";
        P12 = "|              1)Назад              |";
        //Tabla de puntuacion
        P13 = "\n_________Опции__________";
        P14 = "|  2)Изменить таблицу        |";
        P15 = "|  3)Перезапустить очки   |";
        P16 = "|  0)Назад             |";
        //Dificultad
        P17 = "\n_______Сложность________";
        P18 = "|     1)Легкий   1-10      |";
        P19 = "|     2)Средний   1-25      |";
        P20 = "|     3)Сложный 1-50      |";
        P21 = "|     0)Назад          |";
        //Pistas
        P22 ="______________________Подсказка_____________________";
        P23 = "|         Загаданное число меньше или равно";
        P24 = "|         Загаданное число больше или равно";
        //Valores al jugar
        P25 = "_________________________играя_________________________";
        P26 = "| У вас: ";
        P27 = " жизни     У вас: ";
        P28 = " Очки    сложность: ";
        P29 = "|                        0)Выход                        |";
        //Jugar otra vez
        P30 = "Хотите сыграть еще раз?";
        P31 = "       1)Да 2)Нет       ";
        //ganar
        P32 = "Вы выиграли";
        //perder
        P33 = "Вы проиграли";
        P34 = "Загаданное число: ";
        //Juego Infinito
        P35 = "_____Бесконечная игра_____";
        P36 = "|   1)Начать          |";
        P37 = "|   2)Правила           |";
        P38 = "|   0)Назад         |";
        //Reglas del juego infinito
        P39 = "________________________Правила_________________________";
        P40 = "| Выполняйте математические операции без ошибок |";
        P41 = "| чем больше у вас очков, тем сложнее операции,  |";
        P42 = "| получите максимальное количество очков         |";
        P43 = "|                      0)Назад                      |";
        //Estatus
        P44 = "играет";
        P45 = "Очки";
        ...
        P48 = "Результат был: ";
        //Palabras sueltas
        P49 = "ТОП 10 ОЧКОВ НОРМАЛЬНОЙ ИГРЫ:";
        P50 = "ТОП 10 ОЧКОВ БЕСКОНЕЧНОЙ ИГРЫ:";
        P51 = "Ошибка при сохранении очков";
        P52 = "Таблица очков сброшена.";
        P53 = "До следующего раза";
        P54 = "Недопустимый вариант";
        P55 = "Выберите сложность";
        P56 = "Пусть игра начнется";
        P57 = "Введите случайное число от ";
        P58 = " до ";
        P59 = "Введите свое имя";
        P60 = "Неверный номер";
        P61 = "Недопустимый номер";
        P62 = "Равные числа, вы добавляете 500 очков";
        P63 = "Легкий";
        P64 = "Средний";
        P65 = "Сложный";
        P66 = "Ошибка программы";
        P67 = "У вас нет прав администратора. Операция запрещена.";
        P68 = "У вас есть права администратора. Удаление таблицы";
    }
}